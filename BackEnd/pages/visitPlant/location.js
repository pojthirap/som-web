...
export default function LocationPage({ callAPI, customAlert }) {
    ...
    return (
        <div className="col-12">
            ...
            >
                <div className="row d-flex justify-content-center">
                    <div className="col-12 col-md-4 mt-2">
                        <TextField label={msg.locationName} value="" ref={el => criteriaRef.current.locNameTh = el}></TextField>
                    </div>
            ...
            >
                {initData ?
                    <TextField label={msg.code} disabled value={initData && initData.locCode ? initData.locCode : ""} ref={el => inputRef.current.locCode = el}></TextField>
                    :
                    null
                }
                <TextField label={msg.locationName} require value={initData && initData.locNameTh ? initData.locNameTh : ""} ref={el => inputRef.current.locationName = el}></TextField>
                ...
                <div className="row">
                    <div className="col-6 pl-0">
                        <TextField label={msg.latitude} allowChar="NUM OTHER" maxLength={50} require value={initData && initData.latitude ? initData.latitude : ""} ref={el => inputRef.current.latitude = el}></TextField>
                    </div>
                    <div className="col-6 pr-0">
                        <TextField label={msg.longitude} allowChar="NUM OTHER" maxLength={50} require value={initData && initData.longitude ? initData.longitude : ""} ref={el => inputRef.current.longitude = el}></TextField>
                    </div>
