    ...
    return (
        <div className="col-12">
            ...
            <Modal
                ...
                title={msg.qrMaster}
            >
                <TextField label={msg.custCode} disabled value={selectOdj && selectOdj.custCode ? selectOdj.custCode : ""} ref={el => inputRef.current.custCode = el}></TextField>
                <TextField label={msg.custName} disabled value={selectOdj && selectOdj.custNameTh ? selectOdj.custNameTh : ""} ref={el => inputRef.current.custName = el}></TextField>
                {addOrEdit ?
                    <div>
                    ...
                    <div>
                        ...
                        <TextField disabled label={msg.dispenser} value={initData && initData.dispenserNo ? toString(initData.dispenserNo) : ""} ref={el => inputRef.current.dispenserNo = el}></TextField>
                        <TextField disabled label={msg.nozzle} value={initData && initData.nozzleNo ? toString(initData.nozzleNo) : ""} ref={el => inputRef.current.nozzleNo = el}></TextField>
                        <Switch
