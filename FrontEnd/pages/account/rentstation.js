...
export default function rentstation({ callAPI, redirect, customAlert }) {
    ...
    const searchProspectData = async (jsonRequest) => {
        ...
        jsonRequest.model.prospectType = "1";
    ...
    const handleClickCard = (data) => {
        dispatch(redirect("/account/menuSelect", { data: data, type: "1" }))
    }
    return (
        <div>
            <AccountTagHistory />
            <div className="container pb-5">
                ...
                <div className="row d-flex justify-content-between">
                    <span className="h1 padding-row">{msg.rentstation}</span>
                </div>
                <div className="row">
                    <CardTable
                        headerLabel={msg.myRentstation}
