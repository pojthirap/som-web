...
export default function Main(pageProps) {
    ...
    return (
        <ReportBase
            {...pageProps}
            inputRef={inputRef}
            pageTitle={msg.visitPlanDaily}
            headerTabel={headerTabel}
            fetchAPIPath={apiPath.reportRep03VisitPlanDaily}
            exportAPIPath={apiPath.exportRep03VisitPlanDaily}
            tablewidth="1500px"
...
const headerTabel = [
    ...
    {
        title: msg.reportLocationName,
        data: "locationName",
        type: "string",
    },
    {
        title: msg.reportStatus,
        data: "status",
        type: "string",
    }
]